...
<section class="bg-light py-3 py-md-5 py-xl-8" id="contact">
    <div class="container">
                    ...
                    <div class="col-12 col-xl-11">
                        ...
                        <div class="d-flex mb-5">
                            ...
                            <div>
                                ...
                                <address class="mb-0 text-secondary">1204, J Block, Sector - 78, Noida, UP, India</address>
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-12 col-sm-6">
                                <div class="d-flex mb-5 mb-sm-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">
                                            <a class="link-secondary text-decoration-none" href="tel:+919911947944">+91 9911947944</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="d-flex mb-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">
                                            For Enquery :  <a class="link-secondary text-decoration-none" href="mailto:shweta@boosttech.in">shweta@boosttech.in</a>
                                            <br>For Job :<br><a class="link-secondary text-decoration-none" href="mailto:hr@boosttech.in"> hr@boosttech.in</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <p class="text-secondary mb-0">Close</p>
                                </div>
                            </div>
                        </div>
                    </div>
