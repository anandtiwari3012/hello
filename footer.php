            ...
            <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                    <div class="footer-logo-wrapper text-center text-sm-start">
                        <a href="#!">
                            <img src="assets/logo.jpeg" alt="Boost Tech Logo" width="175" height="57">
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="credits text-secondary text-center mt-2 fs-8">
                        Built by <a href="https://boosttech.in/index.php#home" class="link-secondary text-decoration-none">Boost Tech</a> with <span class="text-primary">&#9829;</span>
                    </div>
                </div>
            </div>
        </div>
