...
<section class="bg-light py-3 py-md-5 py-xl-8" id="service">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="card border-0 border-bottom border-primary shadow-sm">
                            <div class="card-body text-center p-4 p-xxl-5">
                                ...
                                <p class="mb-4 text-secondary">We can help you to create a user-friendly software's. We take into account your brand identity and target audience.</p>
